...
export default function() {
  return sample(882, 2, [
    new Feature("Target", 1, UNIT, [withinContactDistance], [applyEnemyHealth, applyTarget]),
    new Feature("Far enemies", [0, 6], UNIT, [noCollisions, outsideContactDistance], [applyEnemyHealth]),
  ]);
}
