...
export default function() {
  const generator = new Generator()
    ...
    .add(new Feature("Enemy", [0, 3], UNIT, [outsideFarDistance]))
    .add(new Feature("Support", [0, 3], UNIT, [withinMediumDistance, outsideTargetFarDistance, outsideEnemyFarDistance]));
